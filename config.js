module.exports = {
  OWNER_IDS: ["811598981527240714"], // Bot owner ID's
  SUPPORT_SERVER: "https://discord.gg/rNSJNayteF", // Your bot support server
  PREFIX_COMMANDS: {
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "1378563181793906740", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  EMBED_COLORS: {
    BOT_EMBED: "#068ADD",
    TRANSPARENT: "#36393F",
